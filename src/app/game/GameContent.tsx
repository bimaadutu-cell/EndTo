...
import { Gamepad2, ArrowLeft, Trophy, Timer, CheckCircle, XCircle } from "lucide-react";
...
const gameQuestions: Record<string, { question: string; options: string[]; correct: number; explanation: string }[]> = {
  matematika: [
    ...
    { question: "Faktor dari 12 adalah...", options: ["1, 2, 3, 4, 6, 12", "1, 2, 4, 8, 12", "1, 3, 4, 6, 12", "2, 3, 4, 6, 12"], correct: 0, explanation: "Faktor 12: 1, 2, 3, 4, 6, 12" },
    { question: "Hasil dari 15 ÷ 3 + 2 adalah...", options: ["5", "6", "7", "8"], correct: 2, explanation: "15 ÷ 3 = 5, 5 + 2 = 7" },
  ],
  informatika: [
    ...
    { question: "RAM berfungsi untuk...", options: ["Penyimpanan permanen", "Penyimpanan sementara", "Memproses data", "Menampilkan grafik"], correct: 1, explanation: "RAM (Random Access Memory) untuk penyimpanan sementara" },
    { question: "IP Address terdiri dari ... bit (IPv4)", options: ["16", "32", "64", "128"], correct: 1, explanation: "IPv4 menggunakan 32 bit" },
    { question: "Bahasa pemrograman untuk web interaktif adalah...", options: ["HTML", "CSS", "JavaScript", "PHP"], correct: 2, explanation: "JavaScript membuat web menjadi interaktif" },
  ],
  sains: [
    { question: "Rumus kimia air adalah...", options: ["H2O", "CO2", "O2", "H2O2"], correct: 0, explanation: "Air = H2O (2 Hidrogen + 1 Oksigen)" },
    ...
    { question: "Proses tumbuhan membuat makanan disebut...", options: ["Respirasi", "Fotosintesis", "Transpirasi", "Fermentasi"], correct: 1, explanation: "Fotosintesis adalah proses pembuatan makanan tumbuhan" },
    { question: "Satuan gaya adalah...", options: ["Joule", "Watt", "Newton", "Pascal"], correct: 2, explanation: "Satuan gaya = Newton (N)" },
    { question: "Hukum Newton yang pertama adalah...", options: ["F = m × a", "Hukum Inersia", "Aksi = Reaksi", "Hukum Gravitasi"], correct: 1, explanation: "Hukum I Newton = Hukum Inersia" },
  ],
  agama: [
    { question: "Rukun Islam ada ... ", options: ["4", "5", "6", "7"], correct: 1, explanation: "Rukun Islam ada 5" },
    { question: "Shalat wajib dalam sehari ada ... kali", options: ["3", "4", "5", "6"], correct: 2, explanation: "Shalat wajib 5 waktu: Subuh, Dzuhur, Ashar, Maghrib, Isya" },
    { question: "Nabi terakhir adalah...", options: ["Nabi Isa", "Nabi Musa", "Nabi Muhammad SAW", "Nabi Ibrahim"], correct: 2, explanation: "Nabi Muhammad SAW adalah nabi terakhir" },
    { question: "Kitab suci umat Islam adalah...", options: ["Taurat", "Injil", "Zabur", "Al-Qur'an"], correct: 3, explanation: "Al-Qur'an adalah kitab suci umat Islam" },
    { question: "Malaikat yang bertugas menyampaikan wahyu adalah...", options: ["Malaikat Mikail", "Malaikat Jibril", "Malaikat Israfil", "Malaikat Izrail"], correct: 1, explanation: "Malaikat Jibril bertugas menyampaikan wahyu" },
  ],
};
